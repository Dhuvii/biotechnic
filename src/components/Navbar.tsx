...
const Navbar = () => {
  ...
  return (
    <nav className="relative isolate z-40 -mt-10 flex w-full items-center justify-between px-5 lg:px-14">
      <Link
        href="/"
        className="relative mt-10 h-28 w-32 shrink-0 rounded-2xl bg-black/10 p-1 backdrop-blur-xs lg:h-48 lg:w-60"
      >
        <Image
          fill
          src={Logo}
      ...
      <div className="flex w-full items-center justify-end gap-5">
        <div className="hidden items-center justify-end gap-5 lg:flex">
          ...
          <div className="hidden h-10 w-1 rounded-full bg-white lg:block"></div>
        </div>

        <Dropdown open={isMobileNavOpen} onOpenChange={setIsMobileNavOpen}>
          <div className="group relative flex items-center justify-center lg:hidden">
            <div className="absolute -inset-1 bg-white/70 blur-lg group-hover:bg-white/20"></div>
            <Dropdown.Button
              className={cn(
          ...
          <Dropdown.Menu
            align="start"
            className="w-72 rounded-xl bg-gradient-to-br from-gray-900 to-gray-950 shadow-xl ring-[1px] ring-gray-800"
          >
            <Dropdown.Item
              onSelect={() => {
                router.push("/about");
